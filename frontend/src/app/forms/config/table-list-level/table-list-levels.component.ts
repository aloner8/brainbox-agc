...
import { LevelDetailDialogComponent,LevelDetailDialogData } from './level-dialog.component';
...
@Component({
    selector: 'table-list-levels',
    templateUrl: './table-list-levels.component.html',
    styleUrls: ['./table-list-levels.component.scss']
})
export class TableListLevelsComponent implements OnInit {
  ...
  //console.log(row)
      ...
      //console.log('level_masters:',rows)
             if(rows){
                 ...
                 const dialogRef = parent.DetailDialog.open(LevelDetailDialogComponent, {
                  data: _my_ideas,
                });
