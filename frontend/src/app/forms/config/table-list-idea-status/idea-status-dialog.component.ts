...
@Component({
    selector: 'idea-status-dialog',
    templateUrl: './idea-status-dialog.component.html',
    styleUrls: ['./idea-status-dialog.component.css'],
   // standalone: true,
  /*   imports: [
      MatFormFieldModule,
      MatInputModule,
...
export class IdeaStatusDetailDialogComponent  {
  ...
  ErrorLabel:string = ''
  displayedColumns: string[] = ['id', 'name_button', 'isadmin','isideaby','isdefaultcoordinator','isapproveridea','iscoordinatoridea','ismember'];

    constructor(
        public dialogRef: MatDialogRef<IdeaStatusDetailDialogComponent>,
