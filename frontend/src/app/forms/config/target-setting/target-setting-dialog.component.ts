...
@Component({
    selector: 'target-setting-dialog',
    templateUrl: './target-setting-dialog.component.html',
    styleUrls: ['./target-setting-dialog.component.css'],
   // standalone: true,
  /*   imports: [
      MatFormFieldModule,
      MatInputModule,
...
export class TargetSettingDetailDialogComponent  {
  ...
  ErrorLabel:string = ''
    ...
    constructor(
        public dialogRef: MatDialogRef<TargetSettingDetailDialogComponent>,
