...
@Component({
    selector: 'upload-hall-of-fame-dialog',
    templateUrl: './upload-hall-of-fame-dialog.component.html',
    styleUrls: ['./upload-hall-of-fame-dialog.component.css'],
   // standalone: true,
  /*   imports: [
      MatFormFieldModule,
      MatInputModule,
...
export class UploadHallOfFameDetailDialogComponent  {
  ...
  ErrorLabel:string = ''
    ...
    constructor(
        public dialogRef: MatDialogRef<UploadHallOfFameDetailDialogComponent>,
